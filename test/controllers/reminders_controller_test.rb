...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { aniversario: @reminder.aniversario, assunto: @reminder.assunto, destinatario: @reminder.destinatario, mensagem: @reminder.mensagem }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { aniversario: @reminder.aniversario, assunto: @reminder.assunto, destinatario: @reminder.destinatario, mensagem: @reminder.mensagem }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
